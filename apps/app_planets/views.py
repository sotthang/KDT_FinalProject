...
from apps.app_accounts.models import Accountbyplanet, User, Memobyplanet
from apps.app_accounts.forms import AccountbyplanetForm, MemobyplanetForm
...
def invite_check(request, invite_code):
    ...
    return render(
        ...
        {"planet": planet, "invite_code": invite_code},
    )
